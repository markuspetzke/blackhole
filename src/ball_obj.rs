...
use crate::{
    SRC_HEIGHT, SRC_WIDTH, ball_mesh::BallMesh, collision::*, line_renderer::LineRenderer,
};
...
impl BallObject {
    ...
    pub fn render(&mut self, shader_program: u32, projection: &Mat4, light_pos: &Vec3) {
        ...
        unsafe {
            ...
            gl::Uniform2f(lightloc, light_pos.x, light_pos.y);
